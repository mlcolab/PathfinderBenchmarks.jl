...
ArviZ.use_style("arviz-white")

# ╔═╡ 4ec0cd1e-36b7-4d22-b943-298186449c76
pdb = PosteriorDB.database()

# ╔═╡ 3738ceb4-2519-4878-a581-992d1bc5081c
post = PosteriorDB.posterior(pdb, "eight_schools-eight_schools_centered")

# ╔═╡ 7ad730a4-f85c-4e5d-903d-7c5e2dd65d45
...
# ╔═╡ e3f104ea-2c22-4d42-b7dc-fa2ce4899804
cov_post = cov(reshape(draws.x, :, size(draws.x, :param)); dims=1)

# ╔═╡ 86007fc4-6797-4101-b4c1-c80cb2c45677
cond(cov_post)

# ╔═╡ 1d024fdf-ea9f-4572-bc37-480085e541a4
conddiag(cov_post)
...
manifest_format = "2.0"
project_hash = "7ee447e766f1dd2cfc94620166c6ee2976c24bfe"
...
[[deps.ArviZ]]
deps = ["ArviZExampleData", "Conda", "DataDeps", "DataFrames", "Dates", "DimensionalData", "InferenceObjects", "InferenceObjectsNetCDF", "JSON3", "LogExpFunctions", "Markdown", "OrderedCollections", "PSIS", "PyCall", "PyPlot", "REPL", "Requires", "StatsBase"]
git-tree-sha1 = "56c4e1bb518bcf80578c0e7101a79616e61d96d2"
uuid = "131c737c-5715-5e2e-ad31-c244f01c1dc7"
version = "0.8.1"

[[deps.ArviZExampleData]]
deps = ["Artifacts", "DataDeps", "InferenceObjectsNetCDF", "JSON3", "OrderedCollections", "StructTypes"]
git-tree-sha1 = "e1a1ddbcd6d4f2ce6e37d6517d200c2a36e47e66"
...
[[deps.InferenceObjectsNetCDF]]
deps = ["DimensionalData", "InferenceObjects", "NCDatasets", "Reexport"]
git-tree-sha1 = "df810364efb242e3f83f51446d5745afe2416eb4"
...
git-tree-sha1 = "a88ea063dc34aae126e07d48f3c97943c414dda2"
...
git-tree-sha1 = "ed860fa12283d6f6354098b8184f00fba4de8e6b"
